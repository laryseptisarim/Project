...
{{csrf_field()}}
  <div class="row mb-3">
   <label class="col-sm-2 col-form-label">Mata Pelajaran</label>
    <div class="col-sm-10">
      <input name="mapel" type="text" class="form-control" placeholder="Nama mata pelajaran" value="{{$mapel->mapel}}">
    </div>
  </div>
  <br>
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input name="guru" type="text" class="form-control" placeholder="Guru yang mengajar" value="{{$mapel->guru}}">
    </div>
  </div>
  <br>
  <div class="row mb-3">
    <label class="col-sm-2 col-form-label" value="{{$mapel->kelas}}">Kelas</label>
    <div class="col-sm-10">
  ...
  <br>
  <div class="row mb-3">
    <label class="col-sm-2 col-form-label" value="{{$mapel->jurusan}}">Jurusan</label>
    <div class="col-sm-10">
